...
(* Last updated: January 8, 2010 by Douglas Baldwin and Willy Hereman *)
(* in Boulder at 16:50 *)
...
PDESpecialSolutions`dominantBehavior::freevalues = "The solution(s) `1` do not
fix all the values of \!\(M\_i\).  We will now generate all the possible
values for the free \!\(M\_i\) up to the user option MaxDegreeOfThePolynomial
...
PDESpecialSolutionsmSolver::remove = "The potential solutions `1` are being
...
(* WH:01/23/2009 set buildSystemDebug to True for testing, back to False *)
(* after testing *)
...
(* WH:01/04/2010 Added a print statement *)
    If[VerboseTest,
      ...
      numericTestSolutions = 
        Complement[solutionRules, solns];
...
Print["Version 2, last updated by Hereman on January 8, 2010."];
Print["Previously updated by Goktas on December 13, 2009"];
Print["and by Hereman on January 23, 2009."];
